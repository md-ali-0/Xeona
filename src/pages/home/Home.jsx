const Home = () => {
    return (
        <>
            <div className="pt-5 md:py-5 xl:container m-auto px-6 md:px-12">
                <div
                    aria-hidden="true"
                            ...
                            <form action="" className="w-full mt-12">
                                <div className="relative flex items-center px-2 p-1 rounded-full bg-white dark:bg-gray-900 border dark:border-gray-700 border-primary/10 shadow-md md:p-2 lg:pr-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-4 focus:outline-none rounded-full placeholder-gray-600 dark:placeholder-white bg-transparent"
                                        type="email"
                                    />
